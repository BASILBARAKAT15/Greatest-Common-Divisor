...
vlib work && vcom '-2019' '-o' ASM.vhd BineryTOBCD.vhd design.vhd testbench.vhd  && vsim -c -do "vsim TB_MainDesign; run 700ns; exit"  ; echo 'Creating result.zip...' && zip -r /tmp/tmp_zip_file_123play.zip . && mv /tmp/tmp_zip_file_123play.zip result.zip